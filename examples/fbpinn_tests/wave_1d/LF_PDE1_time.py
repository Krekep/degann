...
class LF_PDE1(PhysLoss):
    ...
    def phys_loss(
        ...
        **kwargs
        ...
        # phys_loss = tf.reduce_mean(tf.abs(u_true - u_model)) / tf.reduce_mean(tf.abs(u_true))
    ...
    def boundary_loss_1(
        ...
        **kwargs
        ...
        phys_loss = tf.reduce_mean(tf.abs(u_true - u_model)) / tf.reduce_mean(
            tf.abs(u_true)
        )
    ...
    def boundary_loss_2(
        ...
        **kwargs
        ...
        # phys_loss = tf.reduce_mean(tf.abs(u_true - u_t)) / tf.reduce_mean(tf.abs(u_true))
