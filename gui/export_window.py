...
class ExportNNLayout:
    ...
    def setup_export_area(self):
        ...
        export_button.setSizePolicy(expand_fixed_police_size)
        export_button.setMinimumSize(QtCore.QSize(50, 40))
        ...
        export_cpp_button.setSizePolicy(expand_fixed_police_size)
        export_cpp_button.setMinimumSize(QtCore.QSize(50, 40))
